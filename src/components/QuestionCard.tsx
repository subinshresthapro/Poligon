...
const OPTIONS: { value: ScoreValue; label: string; shortLabel: string; color: string; bg: string; selectedBg: string }[] = [
  {
    value: -2,
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center justify-center py-3 px-2 rounded-xl border-2 text-xs font-medium transition-all leading-tight text-center ${
                isSelected ? opt.selectedBg : `${opt.bg} ${opt.color} bg-white`
              }`}
            >
