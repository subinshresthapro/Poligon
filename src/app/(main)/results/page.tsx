  ...
  if (!scores) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p className="text-slate-400">Redirecting to quiz...</p>
      </div>
    );
  }
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 text-sm max-w-xl mx-auto">
            Each spoke represents one political dimension. Distance from center shows your level of support.
            This is <strong>not</strong> a left–right score — it&apos;s a multidimensional map.
          </p>
          ...
          <div className="space-y-4">
            <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-5">
              ...
              <p className="text-xs text-slate-400 mt-4 leading-relaxed">
                Each spoke is a political category. The further a point extends from center, the more
                you support that dimension&apos;s direction.
              </p>
            </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="p-6">
            ...
            {tab === "compare" && (
              <IdeologyComparisonPanel userScores={scores} />
            )}
            {tab === "share" && (
              <ShareExportPanel scores={scores} name="My Shape" />
            )}
          </div>
        </div>
      </div>
